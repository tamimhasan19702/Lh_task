...
<body class="bg-gray-100">
    ...
    <nav
        ...
        <ul class="hidden sm:flex text-gray-400 justify-end items-center gap-x-7 gap-y-5 tracking-wide mt-5 sm:mt-0"
            ...
            <li class="table-caption mb-5 sm:mb-0">
                <a href="./public/pages/page1.html" class="hover:text-gray-300">Link</a>
            </li>
            <li class="mb-5 sm:mb-0 mx-0">
                <a href="./public/pages/page2.html" class="hover:text-gray-300">Link</a>
            </li>
    ...
    <main>
        ...
        <section class="text-center py-32">
            <h1 class="font-bold text-3xl md:text-4xl lg:text-5xl pb-7">A TailwindCSS Starter Template</h1>
            <p class="text-gray-600 mb-3">A complete project boilerplate built with Tailwindcss</p>
        ...
        <footer class="bg-slate-900 pb-3 pt-10 lg:pt-20 text-white">
            ...
            <div class="flex flex-wrap justify-around gap-y-16 gap-x-7 mb-16">
                ...
                <div class="text-center mx-2 mb-5">
                    <h2 class="font-bold text-2xl mb-3 tracking-wider">Template<span
                            class="text-primary-color">Raven</span></h2>
            ...
            <!-- Copyright -->
            <p class="text-center mt-8 mb-4 font-semibold">Template Raven - Copyright &copy; <span id="year"></span>.
                All
                Rights
                Reserved</p>
